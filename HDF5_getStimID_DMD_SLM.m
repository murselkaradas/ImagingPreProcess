function [odorInfo] = HDF5_getStimID_DMD_SLM(fpathH5,fnameH5,varargin)
...
try
    DMDPatternID = deblank(string((H5.patternid)'));
    idx1 = DMDPatternID ~='' ;
    DMDPatternID(idx1)=  'DMD:'+ DMDPatternID(idx1);
    SLMPatternID = deblank(string((H5.SLM_pattern)'));
    idx2 = SLMPatternID ~= "";
    SLMPatternID(idx2) = '\SLM:' + SLMPatternID(idx2);
    PatternID =  DMDPatternID  + SLMPatternID;
catch
