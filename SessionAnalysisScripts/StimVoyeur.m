...
path = '/gpfs/data/rinberglab/Jon/JG44524/230614';
fieldname = 'JG44524_230614_glomfield4_stim';
VoyeurH5_name = 'JG44524_230614_glomfield4_stim_1_01';
img_format = [512, 512];
fps =30;  % for 3X zoom
OdorDuration = 1;%
cd(path);
...
for k = 1:num_cell
    stimframe_(k,:) = findstimframe(squeeze(Fluo_cell(k,:,:)),Voyeur_stim_frame,2);
