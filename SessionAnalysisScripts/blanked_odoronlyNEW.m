...
% SVD_2p_cluster_WS('/gpfs/scratch/karadm01/2Pdata/M72/SC24/220106/BENZ_2HA_morph/SC24_220106_BENZ2HAglom_00001_00001.tif', 1, 40,100,60);
%%  FIELD 1
% Read H5 and roi file
path = '/gpfs/scratch/karadm01/2Pdata/M72/SC46/220617/8odors';
fieldname = 'SC46_220617_8odors';
img_format = [512 512];
if img_format(1)==256
    fps =58.20
else
...
RoiName = dir([strcat(strjoin(tmp(1:end),'_'),'_*.zip')]);
