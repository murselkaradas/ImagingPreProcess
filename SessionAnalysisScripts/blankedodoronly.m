...
% SVD_2p_cluster_WS('/gpfs/scratch/karadm01/2Pdata/SC56R/221002/8odors/aligned/SC56R_221002_8odors_00001_00001.tif', 1, 40,100,60);
%%  FIELD 1
% Read H5 and roi file
path = '/gpfs/scratch/karadm01/2Pdata/SC18/220908/12odors';
fieldname = 'SC18_220908_12odors';
img_format = [256, 256];
img_format = [512, 512];
if img_format(1)==256
    fps =58.18
...
pre = 2000;
post = 4000;
[sniff,frametrigger,Data,~]=read_sniff_frametrigger_trialinfo(h5_name,path_h5,pre,post,true,fps,wsFrameNumbers);
