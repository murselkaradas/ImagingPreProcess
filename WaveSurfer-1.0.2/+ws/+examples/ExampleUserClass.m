classdef ExampleUserClass < ws.UserClass
    ...
    methods        
        ...
        function startingSweep(self, wsModel)  %#ok<INUSD>
            ...
            self.TrialInfo.TrialNumber = self.TrialInfo.TrialNumber + 1;
            fprintf('%s  About to start a sweep Number: %d .  Time at start of run: %s\n', ...
                    self.Greeting,self.TrialInfo.TrialNumber,self.TimeAtStartOfLastRunAsString_);
        end
